...
namespace TheWebShop.Migrations
{
    ...
    [Migration("20230112132143_makeProductlistNullable")]
    partial class makeProductlistNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheWebShop.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TheWebShop.Models.Cart", b =>
                {
                    b.HasOne("TheWebShop.Models.Customer", "Customer")
                        .WithOne("Cart")
                        .HasForeignKey("TheWebShop.Models.Cart", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
